...
<div class="card <?= \Altum\Alerts::has_field_errors() ? 'border-danger' : null ?>">
    <div class="card-body">
        <div class="row mb-4">
            <div class="col-4">
                <a href="<?= url('admin/language-update/' . $data->language['name']) ?>" class="btn btn-block btn-outline-primary <?= !$data->type ? 'disabled' : null ?>"><?= l('admin_languages.main_settings') ?></a>
            </div>

            <div class="col-4">
                <a href="<?= url('admin/language-update/' . $data->language['name'] . '/app') ?>" class="btn btn-block btn-outline-primary <?= $data->type == 'app' ? 'disabled' : null ?>"><?= l('admin_languages.translate_app') ?></a>
            </div>

            <div class="col-4">
                <a href="<?= url('admin/language-update/' . $data->language['name'] . '/admin') ?>" class="btn btn-block btn-outline-primary <?= $data->type == 'admin' ? 'disabled' : null ?>"><?= l('admin_languages.translate_admin') ?></a>
            </div>
        </div>
