                                    ...
                                    <?php foreach($data->values['settings']['vcard_phone_numbers'] ?? [] as $key => $phone_number): ?>
                                        <div class="mb-4">
                                            <div class="form-group">
                                                ...
                                                <input id="<?= 'vcard_phone_number_' . $key ?>" type="text" name="vcard_phone_number[<?= $key ?>]" value="<?= $phone_number ?>" class="form-control" maxlength="<?= $data->qr_code_settings['type']['vcard']['phone_number']['max_length'] ?>" required="required" />
                                            </div>
